	...
	<div class="top">
		<div class="zerogrid">
			<ul class="top-social f-left">
				<li ><a href="../showcategory/Memshowdatafood.php"><img src="../img/home.png"></a></li>
			</ul>
					...
					<div class="header">
						<div class="center" align="center" >
							...
							<!-- ค้นหาอาหารตามหมวดหมู่ -->
					            	<form class="uk-form" action="../showcategory/result_Memsearch.php" method="post">
						...
						<div class="center" align="center" >
							...
							<tr>
								...
								<td align="center" height="100" width="100 ">
									...
									<a href="fromupdate.php" class="button button-1">เลือก</a>
