              ...
              <!-- Header -->
                <header id="header">
                  <a href="../Employee/Employee_manage.php" class="logo"><strong>ร้านอาหาร :</strong> เฮือนฝ้ายคำ.
                    ...
                    <!-- Content -->
                      <section>
                        <form action="33333.php" method="post" enctype="multipart/form-data">
                          <h2>แก้ไขข้อมูลอาหาร รหัส <?php echo $pid; ?></h2>

                          <label for="category">เลือกประเภทข่าว</label>
                              ...
                              <input type="text" name="firstname" value="<?php echo $row_product['name']; ?>" required>
                              
                              <br>
                              <label for="detail">รายละเอียดอาหาร</label>
                              <input type="text" name="lastname" value="<?php echo $row_product['detail']; ?>"  required>
                             
                             <br>
                              <img src="<?php echo $row_product['img']; ?>" width="150px" height="120px">
                              ...
                              <input type="hidden" name="pid" value="<?php echo $row_product['pid']; ?>">
