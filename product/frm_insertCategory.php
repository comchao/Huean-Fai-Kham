                          ...
                          <?php
                           ...
                           ?>
                            <tr>
                               ...
                               <td><a href="../product/deletedtCate.php?id=<?= $row_data['category_id']; ?>" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่ ?');" >ลบ</a></td>   
                              <td><a href="../product/frm_updateCategory.php?id=<?= $row_data['category_id']; ?>">แก้ไข</a></td>
                             </tr>
                         </form>
                          <?php }?>
                      </table>
