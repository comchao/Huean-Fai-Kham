              ...
              <!-- Header -->
                ...
                <section>
                  <header class="main">
                    ...
                    <form name="insertProduct" class="insertProduct" method="post" action="1212.php" enctype="multipart/form-data"> 
 ...
 ?>
                    ...
                    <table>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo $row_member['img']; ?> "
                                       target="_blank"><?php echo $row_member['img']; ?></a></td>
                          <td><?php echo $row_member['price']; ?></td>

                          <td><a href="../product/22222.php?id=<?= $row_member['pid']; ?>">แก้ไข</a></td>
                          
                           <!-- ลบข้อมูลข่าว โดยเรียกไปยังฟอร์ม dalete โฟลเดอร์ News -->
                           <td><a href="../product/deleteproduct.php?id=<?= $row_member['pid']; ?>" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่ ?');" >ลบ</a></td> 
                        </tr>
                          <?php } ?>
                      </table>
         <br/>
