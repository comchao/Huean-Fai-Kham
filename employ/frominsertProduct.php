 ...
 ?>
                    ...
                    <table>
                        ...
                        <tr>
                          ...
                          <td><a href="../employ/fromupdateProduct.php?id=<?= $row_member['pid']; ?>">แก้ไข</a></td>
                          
                           <!-- ลบข้อมูลอาหาร โดยเรียกไปยังฟอร์ม deletedtProduct  -->
                           <td><a href="../employ/deleteproduct.php?id=<?= $row_member['pid']; ?>" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่ ?');" >ลบ</a></td> 
                        </tr>
                          <?php } ?>
                      </table>
         <br/>
