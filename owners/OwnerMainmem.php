<?php
  ...
  $sql1 = "SELECT * FROM tblogin WHERE login_status LIKE '0%"."%'";
                  ...
                  <header class="main">
                    <h2>จัดการข้อมูลลูกค้า</h2>
                     ...
                     <br>
                      ...
                      <table>
                        <input class="btn success" type="button" name="button" id="button" value="เพิ่มลูกค้า"  onclick="window.location='frm_Registermem.php'"  />
                        <br><br>
                        <tr>
                          <!--<th>ที่</th>-->
                          <th>ชื่อ</th>
                          ...
                          <tr>
                            ...
                            ?></td>
                            <td><a href="../owners/frm_update_member.php?id=<?= $row_member['login_id']; ?>">แก้ไข</a></td>
