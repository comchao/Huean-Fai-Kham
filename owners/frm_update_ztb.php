<?php
  ...
  $sql = "SELECT * FROM tbzonetable WHERE zone_id='$zone_id'";
          ...
          <div id="main">
            <div class="inner">
              ...
              <!-- Header -->
                     ...
                     <!-- Content -->
                      <section>
                        <form action="update_ztb.php" method="post" >
                          <h2>แก้ไขโซนโต๊ะ รหัส <?php echo $zone_id; ?></h2>
                              
                              <label for="detail">โซนโต๊ะ</label>
                              <input type="text" name="zonename" value="<?php echo $row_data['zone_name']; ?>"  required>
                              <br><br>
                              <input type="submit" class="uk-button" value="บันทึก">
                              <input type="hidden" name="id" value="<?php echo $row_data['zone_id']; ?>">
