...
<div class="center" align="center" >
   <h2 align="center"> รายการอาหาร </h2>
...
<div class="wrap-body">
	...
	<div class="site-title">
		<div class="zerogrid">
			<div class="row">
				<h2 class="t-center">เมนูเครื่องดื่ม</h2>
			</div>
		</div>
	</div>
    <!--//////////////////////////////////////Menu-->
...
?>
		...
		<td align="center" height="100" width="100 ">
			...
			"<br>"."<br>"."ชื่ออาหาร  ".$data["name"]."<br>"
			."ราคา ".$data["price"]." บาท"."<br>" ?>

				<!--<input type="submit" id="buy" name="buy" class="btn btn-default" value="สั่งซื้อ" >-->
				<br><br> </td>
<?php
	}  if($c == 0) {
		$c = $cols;
...
<a href="emcheckorder_cus.php">กลับ</a>
</table>
