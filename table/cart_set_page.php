...
//โซนโต๊ะ
    ...
    if ($result_booktb &$result_tbtable&$result_report&$result_order_status) {
...
//โซนโต๊ะ
   ...
   header("Location: index.php?login_id=$login_id&id_report=$id_report&type=$type&zone_status=$zone_id");
    ...
    header("Location: index.php?login_id=$login_id&id_report=$id_report&type=$type&zone_id=$zone_id&id_table=$id_table&tb_date=$tb_date&tb_time=$tb_time");
