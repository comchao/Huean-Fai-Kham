  ...
  <tbody>
	...
	if(isset($_SESSION["cart_products"])) //check session var
    {
		...
		foreach ($_SESSION["cart_products"] as $cart_itm)
        {
            ...
            <input id="login_id" type="hidden" class="form-control" name="login_id[<?= $product_code ?>][]" value="<?php echo $id_user; ?>">
            <?php
    ...
    <tr><td colspan="5"><a href="index.php" class="button">เพิ่ม</a>
