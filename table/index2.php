...
<center>
    ...
    <form class="uk-form" action="index2.php?login_id=<?php echo $_GET["login_id"]?>&id_report=<?php echo $id_report?>&type=<?php echo $type?>&zone_id=<?php echo $zone_id?>&id_table=<?php echo $id_table?>&tb_date=<?php echo $tb_date?>&tb_time=<?php echo $tb_time?>" method="post">
...
';
    echo '</form>';
    echo '  <?php echo ?>
 <form method="post" action="view_cart.php?login_id='.$_GET["login_id"].'&id_report='.$id_report.'&type='.$type.'&zone_id='.$zone_id.'&id_table='.$id_table.'&tb_date='.$tb_date.'&tb_time='.$tb_time.'");
