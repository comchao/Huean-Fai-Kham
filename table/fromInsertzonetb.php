                          ...
                          <?php
                           ...
                           <form  method="post"  action="updateProduct.php?pidup=<?php echo $data["pid"];?>">
                            <tr>
                               ...
                               <td ><input type="text" name="name" id="name" autofocus value="<?php echo $row_data['zone_name']; ?> " style="width:180px; text-align:center ;"/> </td>  
                              
                                              
                               <td><a href="../table/delete_ztb.php?id=<?= $row_data['zone_id']; ?>" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่ ?');" >ลบ</a></td>   
                              <td align="center"><input type="submit" id="update" name="update" value="แก้ไข"></a></td>
                             </tr>
                         </form>
                          <?php }?>
                      </table>
